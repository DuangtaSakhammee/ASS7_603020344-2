package com.example.ass7_603020344_2
...
class MainActivity : AppCompatActivity() {
    ...
    private fun  testEmployeeDate() {
        EmployeeList.add(Employee("Gim" ,"Female", "s_duangta@kkumail.com" ,200000))
        EmployeeList.add(Employee("Duangta" ,"Female", "duangta@hotmail.com" ,90000))
    }
}
